...
const TodoModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'status': PropertySchema(
      ...
      name: r'status',
      type: IsarType.byte,
      enumMap: _TodoModelstatusEnumValueMap,
    ),
...
TodoModel _todoModelDeserialize(
  ...
  final object = TodoModel(
    ...
    status: _TodoModelstatusValueEnumMap[reader.readByteOrNull(offsets[2])] ??
        TodoStatus.active,
...
P _todoModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_TodoModelstatusValueEnumMap[reader.readByteOrNull(offset)] ??
          TodoStatus.active) as P;
    case 3:
      return (reader.readStringOrNull(offset)) as P;
    default:
...
const _TodoModelstatusEnumValueMap = {
  'active': 0,
  'completed': 1,
  'pending': 2,
};
const _TodoModelstatusValueEnumMap = {
  0: TodoStatus.active,
...
extension TodoModelQueryWhere
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterWhereClause> titleIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterWhereClause> titleIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoModelQueryFilter
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterFilterCondition> statusEqualTo(
      TodoStatus value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'status',
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterFilterCondition> statusGreaterThan(
    TodoStatus value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterFilterCondition> statusLessThan(
    TodoStatus value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterFilterCondition> statusBetween(
    TodoStatus lower,
    TodoStatus upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TodoModelQuerySortBy on QueryBuilder<TodoModel, TodoModel, QSortBy> {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> sortByStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.asc);
    });
  }

  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> sortByStatusDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoModelQuerySortThenBy
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> thenByStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.asc);
    });
  }

  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> thenByStatusDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.desc);
    });
  }
...
extension TodoModelQueryWhereDistinct
  ...
  QueryBuilder<TodoModel, TodoModel, QDistinct> distinctByStatus() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoModelQueryProperty
  ...
  QueryBuilder<TodoModel, TodoStatus, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
